...
best_rf = load('best_rf_model.joblib')  # Ensure you saved the model earlier in training
X_test = pd.read_csv('X_test.csv')
y_test = pd.read_csv('y_test.csv')['virality']  # Assuming y_test was saved with a single column
